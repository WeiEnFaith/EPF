...
class ProfileFragment : Fragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //sharedPreference = requireActivity()
        //.getSharedPreference (getString

        val name = sharedPreference.getString(getString(R.string.name),getString(R.string.nav_header_title))

        val email = sharedPreference.getString(getString(R.string.email),getString(R.string.nav_header_subtitle))
